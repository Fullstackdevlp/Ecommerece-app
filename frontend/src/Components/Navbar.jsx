...
const Navbar = () => {
{/* state variable */}
const [visible,setVisible] = useState(false);   {/* setVisible(true) makes the element visible, while setVisible(false) hides i */}
  ...
  return (
    ...
    <p className='absolute right-[-5px] bottom-[-5px] w-4 text-center leading-4 bg-black text-white aspect-square rounded-full text-[8p]'>{getCartCount()}</p>
    </Link>
    <img onClick={()=>setVisible(true)} src={assets.menu_icon} className='w-5 cursor-pointer sm:hidden' alt="" /> {/* this line for to see menu icon like 3line option */}
    </div>    
